...
export const DEFAULT_STOREFRONT_BANNERS: PromoBanner[] = [
  {
    ...
    image_url: optimizeImageUrl('https://images.unsplash.com/photo-1561181286-d3fee7d55364', 800),
  ...
  },
  {
    ...
    image_url: optimizeImageUrl('https://images.unsplash.com/photo-1606744824163-985d376605aa', 800),
  ...
  },
  {
    ...
    image_url: optimizeImageUrl('https://images.unsplash.com/photo-1526047932273-341f2a7631f9', 800),
